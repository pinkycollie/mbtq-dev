      ...
      <header className="flex justify-between items-center p-6 bg-white/90 backdrop-blur-sm shadow-lg transition-all duration-300 hover:shadow-xl">
        ...
        <div className="flex gap-3">
          <select
            ...
            className="px-3 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full hover:from-pink-600 hover:to-purple-600 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-fuchsia-400 cursor-pointer transition-all font-bold text-sm"
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full hover:from-purple-700 hover:to-pink-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-purple-400 transition-all hover:scale-110 font-bold shadow-lg hover:shadow-xl"
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-700 text-white rounded-full hover:bg-fuchsia-600 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-fuchsia-400 transition-all hover:scale-110 hover:rotate-3 font-bold shadow-lg hover:shadow-xl"
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-gray-700 to-purple-700 text-white rounded-full hover:from-gray-800 hover:to-purple-800 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-purple-400 transition-all hover:scale-110 font-bold shadow-lg hover:shadow-xl"
