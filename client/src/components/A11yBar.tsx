    ...
    >
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-3 py-1 rounded-full text-xs font-bold hover:from-indigo-600 hover:to-purple-600 transition-all hover:scale-105 shadow-md focus:outline-none focus-visible:ring-4 focus-visible:ring-purple-400 focus-visible:ring-offset-2"
      ...
      <div className="flex gap-3">
        <button
          ...
          className={`px-4 py-2 rounded-full text-white font-bold transition-all hover:scale-110 shadow-md hover:shadow-lg focus:outline-none focus-visible:ring-4 focus-visible:ring-pink-400 focus-visible:ring-offset-2 ${
            contrast
        ...
        <button
          onClick={runAxeCheck}
          className="bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 rounded-full text-white font-bold hover:from-blue-700 hover:to-indigo-700 transition-all hover:scale-110 shadow-md hover:shadow-lg focus:outline-none focus-visible:ring-4 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
        >
          🔍 Run A11y Check
        </button>
      </div>
