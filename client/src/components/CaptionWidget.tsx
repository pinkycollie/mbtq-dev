    ...
    <>
      ...
      <div className="fixed bottom-20 left-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-xl p-4 z-40">
        ...
        <div className="space-y-3">
          {/* Visibility Toggle */}
          <label htmlFor="show-captions" className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              checked={isVisible}
              onChange={(e) => setIsVisible(e.target.checked)}
              id="show-captions"
              className="w-5 h-5 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
          ...
          <div>
            ...
            <select
              ...
              id="font-size"
              className="w-full border border-gray-300 rounded px-2 py-1 text-sm focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
