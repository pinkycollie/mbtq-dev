...
export default function PinkSyncWidget({ socket, id, initial, onCelebrate }: Props) {
  ...
  return (
    <div
      ...
      className={`bg-pink-50 border-2 border-pink-500 rounded-xl shadow-lg p-4 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-pink-400 focus-visible:ring-offset-2 transition-all duration-300 cursor-move ${
