...
export const ActionLog: React.FC<ActionLogProps> = ({ events }) => {
  return (
    <div
      className="bg-gray-900 rounded-lg p-4 max-h-64 overflow-y-auto focus-visible:ring-2 focus:outline-none focus-visible:ring-purple-500"
      tabIndex={0}
      role="region"
    ...
    >
      ...
      <div className="space-y-2">
        {events.length === 0 ? (
          <div className="text-gray-500 text-center py-4 italic border border-dashed border-gray-700 rounded-lg">
