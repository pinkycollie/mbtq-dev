        ...
        <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <button
              ...
              className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800 focus-visible:ring-gray-400"
            >
              Reset to Idle
            </button>
          </div>
          ...
          <div className="border-t border-gray-700 pt-6 space-y-4">
            ...
            <div>
              <label id="panel-pos-label" className="block text-sm font-medium text-gray-400 mb-2">Panel Position</label>
              <div className="flex gap-2" role="group" aria-labelledby="panel-pos-label">
